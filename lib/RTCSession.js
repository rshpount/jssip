  ...
  _createLocalDescription(type, constraints)
  {
    ...
    return Promise.resolve()
      ...
      .then(() =>
      {
        ...
        if (connection.iceGatheringState === 'complete')
        {
          // const l = (connection.localDescription.sdp.match(/a=candidate:/g) || []).length;
          // console.warn('candidate in sdp:', l);
        ...
        // Add 'pc.onicecandidate' event handler to resolve on last candidate.
